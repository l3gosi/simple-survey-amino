...
* `"staff_chat"`: The id of the chat, where questions are going to be sent to (You will be able to get ids of all chats with `!listchats` command after running the bot, so you can skip this step for now)
